...
def test_buy_signal_above_threshold():
    result = compute_signal(technical_score=0.9, momentum_score=0.9, quality_score=0.9,
                            congress_score=0.9, estimate_revisions_score=0.9,
                            earnings_score=0.9)
...
def test_avoid_signal_below_threshold():
    result = compute_signal(technical_score=0.1, momentum_score=0.1, quality_score=0.1,
                            congress_score=0.1, estimate_revisions_score=0.1,
                            earnings_score=0.1)
...
def test_watch_signal_at_midpoint():
    result = compute_signal(technical_score=0.5, momentum_score=0.5, quality_score=0.5,
                            congress_score=0.5, estimate_revisions_score=0.5,
                            earnings_score=0.5)
...
def test_exact_buy_boundary():
    ...
    result = compute_signal(technical_score=0.59, momentum_score=0.59, quality_score=0.59,
                            congress_score=0.59, estimate_revisions_score=0.59,
                            earnings_score=0.59)
    assert result["label"] == "BUY"
...
def test_exact_avoid_boundary():
    ...
    result = compute_signal(technical_score=0.41, momentum_score=0.41, quality_score=0.41,
                            congress_score=0.41, estimate_revisions_score=0.41,
                            earnings_score=0.41)
    assert result["label"] == "AVOID"
...
def test_congress_only_weight_is_008():
    result = compute_signal(technical_score=0.0, momentum_score=0.0, quality_score=0.0,
                            congress_score=1.0, estimate_revisions_score=0.0,
                            earnings_score=0.0)
...
def test_estimate_revisions_only_weight_is_007():
    result = compute_signal(technical_score=0.0, momentum_score=0.0, quality_score=0.0,
                            congress_score=0.0, estimate_revisions_score=1.0,
                            earnings_score=0.0)
    assert result["composite_score"] == pytest.approx(0.07, abs=0.0001)


def test_earnings_only_weight_is_022():
    result = compute_signal(technical_score=0.0, momentum_score=0.0, quality_score=0.0,
                            congress_score=0.0, estimate_revisions_score=0.0,
                            earnings_score=1.0)
    assert result["composite_score"] == pytest.approx(0.22, abs=0.0001)
...
def test_all_weights_sum_to_one():
    ...
    result = compute_signal(technical_score=1.0, momentum_score=1.0, quality_score=1.0,
                            congress_score=1.0, estimate_revisions_score=1.0,
                            earnings_score=1.0)
...
def test_low_quality_gate_forces_watch():
    ...
    result = compute_signal(
        ...
        congress_score=0.90, estimate_revisions_score=0.90,
        earnings_score=0.90,
    )
    assert result["label"] == "WATCH"
...
def test_gate_does_not_affect_avoid_signals():
    ...
    result = compute_signal(
        ...
        congress_score=0.20, estimate_revisions_score=0.20,
        earnings_score=0.20,
    )
    assert result["label"] == "AVOID"
...
def test_analyze_signal_has_estimate_revisions_key_not_trump_policy():
    ...
    result = compute_signal(
        ...
        congress_score=0.6, estimate_revisions_score=0.8,
        earnings_score=0.6,
    )
    ...
    with pytest.raises(TypeError):
        compute_signal(
            technical_score=0.6, momentum_score=0.6, quality_score=0.6,
            congress_score=0.6, trump_policy_score=0.8,
            earnings_score=0.6,
        )
